...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Aeon Agency - <?php require('get_title.php'); ?></title>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index.php" class="logo"><b>Aeon </b>Agency</a>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Aeon Agency</a></strong>
      </footer>
    </div><!-- ./wrapper -->
